...
const Login = () => {
  ...
  return (
    <div className='h-12 shrink-0 flex flex-col justify-start items-center font-serif text-gray-50'>
      <img src='LogYardHori.png' className='h-32 mb-1 mt-12'></img>
      <div className='bg-gray-500/80 p-5 pt-3 rounded-lg mt-28 text-center'>
        
        <h1 className='text-4xl  pb-2'>Guest Login:</h1>
        <TextInput type='password' onChange={(e)=>setServerPassword(e.target.value)} placeholder='Server Password' className='w-96 px-4 py-2 mt-1 border border-brown-700 rounded-lg focus:ring-brown-500 focus:border-orange-900 p-2 italic placeholder-gray-200 bg-transparent'/>
