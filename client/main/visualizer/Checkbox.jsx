  ...
  return (
    <div className='h-8 w-1/2 mt-4 mx-5 py-2 bg-custom-darkgreen  rounded-lg flex'>
      <div className='flex items-center mx-2'>
        <input id="default-checkbox" type="checkbox" value="" defaultChecked={displayLine} onClick={() => handleToggle(displayLine, setDisplayLine)} className="w-4 h-4 text-gray-500 bg-gray-100 border-gray-300 rounded dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-800 dark:border-gray-600"></input>
