...
const Dropdown = ({label, className, entries})=>{
  ...
  return (
    <button onFocus={onFocus} onBlur={onBlur} className={`first:rounded-l-lg last:rounded-r-lg relative text-white bg-secondary-700 hover:bg-secondary-800 focus:ring-4 focus:outline-none focus:ring-secondary-300 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-secondary-600 dark:hover:bg-secondary-700 dark:focus:ring-secondary-800 ${className}`} type='button'>
      { label }
